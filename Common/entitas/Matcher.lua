...
function M:match_entity(entity)
    local all_cond = not self._all or entity:_has_all(self._all)
    local any_cond = not self._any or entity:_has_any(self._any)
    local none_cond = not self._none or not entity:_has_any(self._none)
...
return function (all_of_tb, any_of_tb, none_of_tb)
    local key = 'all' .. string_components_ex(all_of_tb)..'any'..string_components_ex(any_of_tb)..'none'..string_components_ex(none_of_tb)
